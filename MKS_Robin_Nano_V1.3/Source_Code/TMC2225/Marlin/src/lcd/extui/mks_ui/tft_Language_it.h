...
#define FILAMENT_TIPS5_TEXT_IT        "Temperatura troppo bassa, avviare riscaldamento" //Temp is too low to go,please heat"
#define FILAMENT_TIPS6_TEXT_IT        "Completato"

#define FILAMENT_CHANGE_TEXT_IT                 "Please click <Load> \nor <unload>,After \npinter pause."
#define FILAMENT_DIALOG_LOAD_HEAT_TIPS_IT       "Riscaldamento ugello, prego attendere..." //Heating up the nozzle,please wait..."
#define FILAMENT_DIALOG_UNLOAD_HEAT_TIPS_IT     "Riscaldamento ugello, prego attendere..." //Heating up the nozzle,please wait..."
...
#define DIALOG_REPRINT_IT                 "Stampa di nuovo" //Print again"
